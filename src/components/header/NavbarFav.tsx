...
import { Container, NavbarDiv, NavbarBlock, Logo, Ul, Li, DivBtn,  Beige, BlueBtn, NavbarLink } from "../../styledComponents/NavbarStyles";

const NavbarFav:React.FC = () => {
   return (
      <NavbarDiv>
         <Container>
            <NavbarBlock>
               <NavbarLink to='/'><Logo src="https://i.ibb.co/z7cMc0f/image.png"></Logo></NavbarLink>
               <Ul>
                  <Li underline><NavbarLink to='/'>Home</NavbarLink></Li>
                  <Li>Tours</Li>
                  <Li>About</Li>
                  <Li>Help</Li>
               </Ul>
               <DivBtn>
                  <NavbarLink to='/favorites'><Beige big backgroundColor={'#DD377D'}>
